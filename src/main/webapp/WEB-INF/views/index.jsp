            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6">
                <div class="single-service wow zoomIn">
                  <i class="fa service-icon fa-flip-vertical"><img src="<c:url value="assets/images/techicons/attlogo.png" />" /></i>
...
<!--                   <span class="workaddress">1125 E Campbell Rd, Richardson, TX - 75081</span><br /> -->
              ...
              <div class="col-md-4 col-sm-6">
                <div class="single-service wow zoomIn">
                   <i class="fa service-icon fa-flip-vertical"><img src="<c:url value="assets/images/techicons/activelogo.png" />" /></i>
...
<!--                   <span class="workaddress">6363 N State Hwy 161, #200, Irving, TX - 75063; 22530 Gateway Center Dr, #100, Clarksburg, MD - 20871</span><br /> -->
              ...
              <div class="col-md-4 col-sm-6">
                <div class="single-service wow zoomIn">
                  <i class="fa service-icon fa-flip-vertical"><img src="<c:url value="assets/images/techicons/adobelogo.png" />" /></i>
...
<!--                   Adobe Dreamweaver / Adobe Flex / Adobe Coldfusion <br /> -->
              ...
              <div class="col-md-4 col-sm-6">
                <div class="single-service wow zoomIn">
                  <i class="fa service-icon fa-flip-vertical"><img src="<c:url value="assets/images/techicons/pramati_icon.png" />" /></i>
              ...
              <div class="col-md-4 col-sm-6">
                <div class="single-service wow zoomIn">
                  <i class="fa service-icon fa-flip-vertical"><img src="<c:url value="assets/images/techicons/reflexis_logo.png" />" /></i>
              ...
              <div class="col-md-4 col-sm-6">
                <div class="single-service wow zoomIn">
                  <i class="fa service-icon fa-flip-vertical"><img src="<c:url value="assets/images/techicons/gallop_icon.png" />" /></i>
